#SE577 Group 1 ~ Microservices: Itinerary

# Train Sim

An application to simulate purchasing train tickets for SE577 Group Homework Assignment 2.

These 2 calls are provided for itinerary:
1) http://localhost:8001/api/itinerary/stops to populate stations
2) http://localhost:8001/api/itinerary/query to populate trips
...
This is a Java web server. It uses trainsim-db and trainsim-planner to answer requests from the frontend. It is where most of the use cases will be implemented. We use a few small libraries to implement the server. Check `trainsim-itinerary-service/pom.xml` for details.
...
#### Debugging trainsim-itinerary-service
